...
function Card({userName, btnText="visit me !" /* default value*/}) { // {userName} also works
    // console.log(props.userName);//when use {userName} use then use userName
...
>
  <div>
    <h1 className="text-[2em] font-medium">{userName}</h1>
